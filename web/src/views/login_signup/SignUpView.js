...
function SignUpView({navigation}) {
  ...
  const [validateTxtEmail, setValidateEmail] = useState(false)
  ...
  const [language, setLanguage] = useState({ value: 'en_US' })

  const GENDERS = [
    { name: Translate().male, id: 0 },
    { name: Translate().female, id: 1 },
    { name: Translate().I_WOULD_RATHER_NOT_SAY, id: 2 }
  ]
  ...
  const renderWelcome = () => {
    return (
      <ScrollView style={styles.marginR20}>
        <Text style={[
          customTxt(Fonts.Bold, 24, color040404).txt,
          styles.titleStyle
        ]}>{Translate().WELCOM_TO_SALUBERMD}</Text>
        <TextInputView
        ...
        />
        <TextInputView
          title={Translate().REGISTRATION_CODE}
          placeholder={Translate().REGISTRATION_CODE}
          rightIcon={true}
    ...
    return (
      ...
      >
        <Text style={[
          customTxt(Fonts.Bold, 24, color040404).txt,
          styles.titleStyle
        ]}>{Translate().TERMS_CONDITIONS}</Text>
    ...
    return (
      <ScrollView
        ...
        <Text style={[
          customTxt(Fonts.Bold, 24, color040404).txt,
          styles.titleStyle
        ]}>{Translate().PRIVACY_POLICY_TITLE}</Text>
    ...
    return (
      <ScrollView style={styles.marginR20}>
        <Text style={[
          customTxt(Fonts.Bold, 24, color040404).txt,
          styles.titleStyle
        ]}>{Translate().TELL_US_MORE_ABOUT_YOU}</Text>
        <TextInputView
        ...
        />
        <TextInputView
          title={Translate().birthday_member}
        ...
        />
        <TextInputView
          title={Translate().gender1}
          value={gender?.name || ''}
          onChangeTxt={(txt) => setGender(txt)}
          placeholder={Translate().gender1}
          onPressDropDown={() => setShowGender(true)}
          imgStyle={styles.imgStyle}
          validate={gender?.name ? false : true}
        />
        <TextInputView
          title={Translate().placeOfBirth}
          value={birthPlace}
          onChangeTxt={(txt) => setBirthPlace(txt)}
          placeholder={Translate().placeOfBirth}
        />
        <TextInputView
          title={Translate().ricettario}
          value={country?.text || ''}
  ...
  const renderBottomButton = () => {
    const getNameBT = type === TYPE_SCREEN.TELL_US ? Translate().COMPLETE : Translate().NEXT
    return (
