    ...
    return (
      <View style={styles.marginT16}>
        <Button
          ...
          backgroundColor={step > 0 && date && hour ? color3777EE : colorF0F0F0}
          textColor={step > 0 && date && hour ? colorFFFFFF : colorC1C3C5}
          disabled={step > 0 && date && hour ? false : true}
          onPress={_onPressAdd}
        />
      </View>
    )
