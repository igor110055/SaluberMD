...
import classNames from './DirectCall.css'

import AccCore from 'opentok-accelerator-core'
import 'opentok-solutions-css'

import {apiKey, sessionId, token} from './video_call_html/js/config'
...
class DirectCallWebView extends Component {
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <p>OpenTok Accelerator Core</p>
      </div>
    )
  }
}

export default DirectCallWebView
