...
import SecondOpinionHistory from './SecondOpinionHistory'
...
export default function SecondOpinion() {
  ...
  useEffect(() => {
    const subscription = DeviceEventEmitter.addListener(Routes.HISTORY_SECOND_OPINION, params => {
      if (params?.history) {
    ...
    <View style={styles.container}>
      ...
      <Tab.Navigator
        ...
        <Tab.Screen
          ...
          component={SecondOpinionHistory}
        />
      </Tab.Navigator>
    </View>
  )
