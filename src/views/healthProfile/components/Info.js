    ...
    <View
      ...
      <TouchableOpacity
        ...
        <View style={styles.ctnText}>
          ...
          {address && <View style={styles.flexRow}>
            <Text style={[customTxt(Fonts.SemiBold, 12).txt, txtSubTitleColor]}>{address}</Text>
            <Text style={[customTxt(Fonts.SemiBold, 12).txt, txtSubTitleColor]}>{phycial}</Text>
            <Text style={[customTxt(Fonts.SemiBold, 12).txt, txtSubTitleColor]}>{family}</Text>
          </View>}
        </View>
