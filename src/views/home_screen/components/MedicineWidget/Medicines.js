...
import { View, Text, StyleSheet, Image, TouchableOpacity, DeviceEventEmitter, FlatList } from 'react-native'
...
import { apiMedicine } from '../../../../api/Auth'
...
export default function Medicines() {
  ...
  const callAPIMedicine = () => {
    ...
    dispatch(apiMedicine()).then(res => {
      console.log('MedicineWidget: ', res?.payload?.medicine)
