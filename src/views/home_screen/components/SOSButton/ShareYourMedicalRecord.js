      ...
      <View style={styles.fullView}>
        ...
        <View style={styles.marginV24}>
          <Text style={customTxt(Fonts.Bold, 14, colorF5455B).txt}>
            {Translate(languageRedux).EXPIRED_CODE} {`${countDown / 60}`.substring(0, 1)} {Translate(languageRedux).MINS} {countDown % 60} {Translate(languageRedux).seconds}</Text>
        </View>
        ...
        <Button
          ...
          text={Translate(languageRedux).SHARE}
