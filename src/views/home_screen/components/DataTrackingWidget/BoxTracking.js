            ...
            <View style={styles.ctnNoti}>
              ...
              {param2 && (
                <View style={[styles.ctnStatus, txtBgParam, marginBetween]}>
                  <View style={marginHori}>
                    <Text
                      style={[customTxt(Fonts.Regular, 12).txt, txtParamColor]}>
                      {param2}
                    </Text>
                  </View>
                </View>
            ...
            isShowParams && param && (
              <View style={styles.ctnNoti}>
                <View style={[styles.ctnStatus, txtBgStatus]}>
                  <View style={marginHori}>
                    <Text
                      style={[fontSizeTxt, txtStatusColor]}>
                      {param}
                    </Text>
                  </View>
                </View>
