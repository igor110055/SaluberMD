...
export default function Medication({route}) {
      ...
      return (
        <View>
          <RenderItem
            ...
            content={passingData?.medicineName}
          />
          {passingData?.medicineId === 1 && (
            <RenderItem
          ...
          <RenderItem
            ...
            content={passingData?.dosage}
          />
          <RenderItem
            category={Translate(languageRedux).genericName}
            content={passingData?.genericName}
          />
          <RenderItem
            category={Translate(languageRedux).since}
            content={passingData?.since ? convertDMMMYYYY(passingData?.since) : ''}
          />
          <RenderItem
            category={Translate(languageRedux).formafarmaco}
            content={passingData?.medicationForm}
          />
          <RenderItem
    ...
    return (
      <View style={styles.container}>
        <Header
          textCenter={Translate(languageRedux).farmaci}
