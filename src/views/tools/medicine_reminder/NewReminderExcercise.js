...
import { View, Text, StyleSheet, DeviceEventEmitter,
  FlatList, TouchableOpacity, Image, Dimensions, Platform, ScrollView } from 'react-native'
...
import { colorFFFFFF, color040404, colorC1C3C5, color3777EE, colorF0F0F0, color000000 } from 'constants/colors'
  ...
  const renderInput = () => {
    return (
      <View style={styles.ctnInphut}>
        <CustomTextInput
          title={Translate(languageRedux).EXCERCISE}
          value={drugName}
