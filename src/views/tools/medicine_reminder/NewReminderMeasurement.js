...
import { View, Text, StyleSheet, DeviceEventEmitter, FlatList, Dimensions,
  TouchableOpacity, Image, Platform, ScrollView} from 'react-native'
...
import { colorFFFFFF, color040404, colorC1C3C5, color3777EE, color000000, colorF0F0F0 } from 'constants/colors'
...
export default function NewReminderExcercise({ onPressCancel, setStatus, setShowNotiAdd }) {
  ...
  const renderInput = () => {
    return (
      <View style={styles.ctnInphut}>
        <CustomTextInput
          title={Translate(languageRedux).MEASUREMENT}
          value={drugName?.name || drugName}
